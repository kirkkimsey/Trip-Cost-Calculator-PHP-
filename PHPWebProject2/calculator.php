...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(isset($_POST['distance'], $_POST['gallon_price'], 
        ...
        echo'<h1>Total Estimated Cost</h1>
            <p>The total cost of driving ' . $_POST['distance'] . 
        ' miles, averaging ' . $_POST['efficiency'] . 
        ' miles per gallon, and paying an average of $' . 
        $_POST['gallon_price'] . ' per gallon, is $' . 
        number_format ($dollars, 2) . '. If you drive an average of '
        . '65 miles per hour, the trip will take approximately '
        . number_format($hours, 2) . 'hours.</p>';
        
    } else { 
        echo '<h1>ERROR!</h1>'
        . '<p class="error">Please enter a valid distance, price '
